function onCreate()
	...
	makeAnimatedLuaSprite('bg', 'greenhill/bg-encore', 0, 0);
	...
	makeLuaSprite('layer1', 'greenhill/layer1-encore', 0, 0);
	setLuaSpriteScrollFactor('layer1', 1.0, 1.0);
	scaleObject('layer1', 4, 4);
	setProperty('layer1.antialiasing', false);
	
	makeAnimatedLuaSprite('sunflower', 'greenhill/plants/sunflower-encore', 472, 176);
	...
	makeAnimatedLuaSprite('purple1', 'greenhill/plants/purpleflower1-encore', 728, 224);
	...
	makeAnimatedLuaSprite('purple2', 'greenhill/plants/purpleflower2-encore', 856, 240);
